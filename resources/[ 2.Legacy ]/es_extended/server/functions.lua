...
function Core.SavePlayer(xPlayer, cb)
    MySQL.prepare('UPDATE `users` SET `accounts` = ?, `job` = ?, `job2` = ?, `job_grade` = ?, `job_grade2` = ?, `group` = ?, `position` = ?, `inventory` = ?, `loadout` = ? WHERE `identifier` = ?', {
...
function Core.SavePlayers(cb)
    ...
    if count > 0 then
        ...
        MySQL.prepare("UPDATE `users` SET `accounts` = ?, `job` = ?, `job2` = ?, `job_grade` = ?, `job_grade2` = ?, `group` = ?, `position` = ?, `inventory` = ?, `loadout` = ? WHERE `identifier` = ?", parameters,
            function(results)
                if results then
...
function ESX.DoesJobExist2(job2, grade2)
